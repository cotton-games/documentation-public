...
### Update 2026-03-26 — Email transactionnel de confirmation de commande
- ce document n'est pas la source de verite pour ce flux;
- le point d'envoi commande/facture a ete branche cote `global` sur le socle AI Studio transactionnel, tout en conservant les gardes metier existantes de premiere facture;
- pour l'etat courant a retenir, lire en priorite:
  - `canon/repos/pro/README.md`
  - `canon/repos/pro/TASKS.md`
