...
- Rejouer le même call Canvas API 2 fois avec le même `event_id` (cf. `docs/assistant_context/SMOKE_CANVAS_API.md`).
...
## Où regarder (WS)
- Fichier: `bingo-musical/src/ws/bingo_server.js` (handler `case "song_start"`).
