...
- `global/web/app/modules/entites/clients/app_clients_functions.php`
  ...
  - les classements sont maintenant tries sur un score agrege (`100` points par participation, bonus `500 / 300 / 200` pour les rangs `1 / 2 / 3` en quiz / blind test et pour les gains de phase `Bingo / Double ligne / Ligne` en bingo), tout en conservant le nb de participations en annexe;
