...
- Perte involontaire: Pause/runtime conservés 1 h; timer stocké et annulé au retour du primary.
- Expiration: revalidation timer + `primaryInstanceId`, clear Hub, `SESSION_ENDED`, fermeture/suppression runtime.
- Callback Hub non bloquant; sortie volontaire, fin naturelle et équipes inchangées. Marker `restart 13-07-2026/02`.
...
- Blind Test dispose maintenant d'une surcouche equipe runtime, limitee a la session WS courante et non persistante.
