...
- Le bloc d'agrégats jeux du BO est maintenant factorisé dans `www/web/bo/includes/bo_reporting_games_aggregates.php`.
- Deux points d'entrée coexistent:
  - `www/web/bo/cron_routine_bdd_maj.php` continue d'executer ce bloc dans la routine historique;
  - `www/web/bo/cron_reporting_games_aggregates.php` permet un lancement isole des agrégats jeux.
