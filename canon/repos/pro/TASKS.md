...
## CORRIGÉ LOCALEMENT — Routage officiel Dashboard mobile — 16/09/2026

- [x] Poursuite sans journal autorisée explicitement par l'utilisateur après HTTP403 ; aucun rechargement serveur, aucune absence de divergence serveur certifiée.
- [x] Cause prouvée : garde Games `71eb3c71` du08/09 sur les favoris nus ; Pro conservait le href individuel. Pas une substitution Pro du11/09.
- [x] Ajouter seulement `master_view=individual` au CTA individuel d'un Dashboard Hub ; gardes, desktop, démo, hors Hub, résultats et contrat papier conservés. Aucun code Games/Global modifié.
- [x] Régression reproduite avant patch (12 échecs/59), 59/59 après ; vrai refresh JS/HTML et garde de clic validés, six suites Pro/trois Games, syntaxe/diff OK. [Preuves, matrice et commandes](../../../notes/dashboard-mobile-individual-master-2026-09-16.md).
- [ ] Recette navigateur authentifiée mobile/desktop après diffusion autorisée ; aucun commit/push/déploiement/restart.
