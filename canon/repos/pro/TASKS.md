...
- [x] Audit cible:
  ...
  - journal AI Studio raw consulte avant patch: `documentation/client/0_ROADMAP_journal_travaux.md`.
- [x] Correctif livre:
  - le rappel `Un animateur peut prendre la main sur la session avec son mobile depuis les options de jeu.` porte une classe dediee dans les deux blocs de conseils;
