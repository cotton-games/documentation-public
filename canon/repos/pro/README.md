...
- dans `Classements par jeu`, l'ordre est maintenant pilote par un score agrege: `100` points par participation, puis bonus `500 / 300 / 200` pour les rangs `1 / 2 / 3` sur `Cotton Quiz` / `Blind Test`, et bonus `500 / 300 / 200` pour les gains de phase `Bingo / Double ligne / Ligne` sur `Bingo Musical`; le nb de participations reste visible entre parentheses a cote du nom;
