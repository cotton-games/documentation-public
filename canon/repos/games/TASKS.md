...
- Anti-bypass bridge (organizer actions):
  - `web/games_ajax.php` vérifie l’offre active pour `session_update`, `prizes_save`, `resetdemo`,
  - exemption démo maintenue,
  - refus `403 offer_inactive` si non-démo sans offre.
