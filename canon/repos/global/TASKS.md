...
- [x] Patch local : Journal léger `game_events`, provenance d’exécution ouverte, garde temporelle avant `open_execution`, commande Remote hors fenêtre refusée, reprise conditionnelle du focus et génération causale.
