...
## Période Stripe importée en PROD — 2026-09-04
...
- Le DDL canonique contient uniquement ces deux ajouts pour cette migration; l'import idempotent phpMyAdmin est fourni dans `ecommerce_offres_to_clients_stripe_current_period_phpmyadmin.sql`.
- Les deux colonnes `DATETIME NULL` ont été confirmées en PROD avant le portage du code. Aucun index n'est ajouté: elles sont lues avec la ligne d'offre, jamais comme clé de recherche ou de jointure dans ce patch.
