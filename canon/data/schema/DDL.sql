...
--
-- Structure de la table `blindtest_session_teams`
--

CREATE TABLE `blindtest_session_teams` (
  `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT,
  `session_id` varchar(128) NOT NULL DEFAULT '',
  `blindtest_session_id` int(10) UNSIGNED NOT NULL DEFAULT 0,
  `id_championnat_session` mediumint(8) UNSIGNED NOT NULL DEFAULT 0,
  `id_client` mediumint(8) UNSIGNED NOT NULL DEFAULT 0,
  `team_runtime_id` varchar(96) NOT NULL DEFAULT '',
  `team_name_snapshot` varchar(80) NOT NULL DEFAULT '',
  `team_name_normalized` varchar(80) NOT NULL DEFAULT '',
  `score_total` int(11) NOT NULL DEFAULT 0,
  `rank_final` smallint(5) UNSIGNED NOT NULL DEFAULT 0,
  `podium_position` tinyint(3) UNSIGNED DEFAULT NULL,
  `players_count` tinyint(3) UNSIGNED NOT NULL DEFAULT 0,
  `members_json` mediumtext DEFAULT NULL,
  `created_at` datetime NOT NULL DEFAULT current_timestamp(),
  `updated_at` datetime NOT NULL DEFAULT current_timestamp() ON UPDATE current_timestamp(),
  `finalized_at` datetime DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `uq_bt_session_team_runtime` (`session_id`,`team_runtime_id`),
  KEY `idx_bt_session_teams_runtime_session` (`blindtest_session_id`),
  KEY `idx_bt_session_teams_championnat_session` (`id_championnat_session`),
  KEY `idx_bt_session_teams_client_name` (`id_client`,`team_name_normalized`),
  KEY `idx_bt_session_teams_pivot` (`id_client`,`id_championnat_session`,`team_name_normalized`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `ecommerce_offres_paniers` (
  ...
  `remise_nom` varchar(255) NOT NULL,
  `remise_pourcentage` tinyint(3) UNSIGNED NOT NULL,
  `prix_reference_ht` decimal(8,2) NOT NULL COMMENT 'Assiette HT contractuelle avant remise; snapshot commercial de l offre client',
  `prix_ht` decimal(8,2) NOT NULL,
  `produit_additionnel_prix_ht` decimal(8,2) NOT NULL,
...
CREATE TABLE `ecommerce_offres_to_clients` (
  ...
  `date_facturation_fin` date NOT NULL,
  `nb_animation` smallint(5) UNSIGNED NOT NULL,
  `reseau_id_offre_delegation_cible` int(11) unsigned NOT NULL DEFAULT '0',
  `reseau_id_offre_client_support_source` int(11) unsigned NOT NULL DEFAULT '0',
  `remise_nom` varchar(255) NOT NULL,
  `remise_pourcentage` tinyint(3) UNSIGNED NOT NULL,
  `prix_ht` decimal(8,2) NOT NULL,
  `produit_additionnel_prix_ht` decimal(8,2) NOT NULL,
  ...
  `stripe_subscription_schedule_id` varchar(255) NOT NULL DEFAULT ''
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
...
CREATE TABLE `ecommerce_remises` (
  ...
  `id_user_maj` tinyint(3) UNSIGNED NOT NULL,
  `id_securite` varchar(255) NOT NULL,
  `duree_remise_mois` smallint(5) UNSIGNED DEFAULT 12
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci ROW_FORMAT=DYNAMIC;
...
--
-- Structure de la table `championnats_sessions_participations_probables`
--

CREATE TABLE `championnats_sessions_participations_probables` (
  `id` mediumint(8) UNSIGNED NOT NULL,
...
--
-- Structure de la table `championnats_sessions_participations_games_connectees`
--

CREATE TABLE `championnats_sessions_participations_games_connectees` (
  `id` mediumint(8) UNSIGNED NOT NULL,
  `id_championnat_session` mediumint(9) NOT NULL DEFAULT 0,
...
--
-- Structure de la table `games_hubs`
--

CREATE TABLE `games_hubs` (
  `id` int(10) UNSIGNED NOT NULL,
...
--
-- Structure de la table `games_hubs_publication`
--

CREATE TABLE `games_hubs_publication` (
  `id` int(10) UNSIGNED NOT NULL,
...
--
-- Structure de la table `games_hubs_prizes`
--

CREATE TABLE `games_hubs_prizes` (
  `id` int(10) UNSIGNED NOT NULL,
  `id_hub` int(10) UNSIGNED NOT NULL DEFAULT 0,
...
--
-- Structure de la table `games_hubs_sessions`
--

CREATE TABLE `games_hubs_sessions` (
  `id` int(10) UNSIGNED NOT NULL,
  `id_hub` int(10) UNSIGNED NOT NULL DEFAULT 0,
...
--
-- Structure de la table `games_hubs_participations_probables`
--

CREATE TABLE `games_hubs_participations_probables` (
  `id` int(10) UNSIGNED NOT NULL,
  `id_hub` int(10) UNSIGNED NOT NULL DEFAULT 0,
  `id_client` mediumint(9) UNSIGNED NOT NULL DEFAULT 0,
  `id_operation_evenement` int(10) UNSIGNED NOT NULL DEFAULT 0,
...
--
-- Structure de la table `programming_quick_operations`
--

CREATE TABLE `programming_quick_operations` (
  `id` int(10) UNSIGNED NOT NULL,
...
--
-- Structure de la table `programming_quick_series_operations`
--

CREATE TABLE `programming_quick_series_operations` (
  `id` int(10) UNSIGNED NOT NULL,
  `id_client` int(10) UNSIGNED NOT NULL DEFAULT 0,
  `idempotency_key` varchar(80) NOT NULL DEFAULT '',
  `command_hash` char(64) NOT NULL DEFAULT '',
...
CREATE TABLE `operations_evenements` (
  ...
  `naming_nom` varchar(255) NOT NULL DEFAULT '',
...
--
-- Index pour la table `championnats_sessions_participations_games_connectees`
--
ALTER TABLE `championnats_sessions_participations_games_connectees`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `uniq_return_token` (`return_token`),
  ADD KEY `idx_session_joueur_equipe` (`id_championnat_session`,`id_joueur`,`id_equipe`),
  ADD KEY `idx_game_player` (`game_slug`,`game_player_id`),
  ADD KEY `idx_game_player_key` (`game_slug`,`game_player_key`),
  ADD KEY `idx_id_joueur` (`id_joueur`),
  ADD KEY `idx_id_equipe` (`id_equipe`);
...
--
-- Index pour la table `games_hubs`
--
ALTER TABLE `games_hubs`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `uniq_games_hubs_token` (`id_securite`),
  ADD UNIQUE KEY `uniq_games_hubs_context` (`id_client`,`hub_date`,`context_type`,`id_operation_evenement`),
  ADD KEY `idx_games_hubs_client_date` (`id_client`,`hub_date`),
  ADD KEY `idx_games_hubs_active_session` (`active_session_id`),
  ADD KEY `idx_games_hubs_presentation_session` (`presentation_session_id`),
  ADD KEY `idx_games_hubs_operation` (`id_operation_evenement`);

--
-- Index pour la table `games_hubs_publication`
--
ALTER TABLE `games_hubs_publication`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `uniq_games_hubs_publication_hub` (`id_hub`);

--
-- Index pour la table `games_hubs_prizes`
--
ALTER TABLE `games_hubs_prizes`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `uniq_games_hubs_prizes_hub_rank` (`id_hub`,`rank`),
  ADD KEY `idx_games_hubs_prizes_hub` (`id_hub`);

--
-- Index pour la table `games_hubs_sessions`
--
ALTER TABLE `games_hubs_sessions`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `uniq_games_hubs_sessions_hub_session` (`id_hub`,`id_session`),
  ADD KEY `idx_games_hubs_sessions_hub_status` (`id_hub`,`status`),
  ADD KEY `idx_games_hubs_sessions_session` (`id_session`);

--
-- Index pour la table `games_hubs_participations_probables`
--
ALTER TABLE `games_hubs_participations_probables`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `uniq_games_hubs_probables_identity` (`id_hub`,`auth_identity_key`),
  ADD KEY `idx_games_hubs_probables_hub_status` (`id_hub`,`status`),
  ADD KEY `idx_games_hubs_probables_ep` (`id_ep_player`);

--
-- Index pour la table `programming_quick_operations`
--
ALTER TABLE `programming_quick_operations`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `uniq_programming_quick_client_key` (`id_client`,`idempotency_key`),
  ADD KEY `idx_programming_quick_expires_at` (`expires_at`),
  ADD KEY `idx_programming_quick_client_status` (`id_client`,`status`);

--
-- Index pour la table `programming_quick_series_operations`
--
ALTER TABLE `programming_quick_series_operations`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `uniq_programming_quick_series_client_key` (`id_client`,`idempotency_key`),
  ADD KEY `idx_programming_quick_series_expires_at` (`expires_at`),
  ADD KEY `idx_programming_quick_series_client_status` (`id_client`,`status`);
...
--
-- AUTO_INCREMENT pour la table `championnats_sessions_participations_games_connectees`
--
ALTER TABLE `championnats_sessions_participations_games_connectees`
...
--
-- AUTO_INCREMENT pour la table `games_hubs`
--
ALTER TABLE `games_hubs`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `games_hubs_publication`
--
ALTER TABLE `games_hubs_publication`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `games_hubs_prizes`
--
ALTER TABLE `games_hubs_prizes`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `games_hubs_sessions`
--
ALTER TABLE `games_hubs_sessions`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `games_hubs_participations_probables`
--
ALTER TABLE `games_hubs_participations_probables`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `programming_quick_operations`
--
ALTER TABLE `programming_quick_operations`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `programming_quick_series_operations`
--
ALTER TABLE `programming_quick_series_operations`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;
