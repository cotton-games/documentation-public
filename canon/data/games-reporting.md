...
## Tables (cron `cron_reporting_games_aggregates.php`)
...
- Le traitement est encapsulé dans `www/web/bo/www/modules/syntheses/facturation_pivot/bo_facturation_pivot_games_aggregates.php` et n'est plus déclenché par `cron_routine_bdd_maj.php`.
