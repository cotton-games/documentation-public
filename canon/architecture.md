...
- **Bridge Canvas (PHP)** : endpoint `global_ajax.php?t=jeux&m=canvas` (dans ce repo: `GAMES/global_ajax.php`) qui :
  ...
  - dispatch vers `game_api_dispatch()` (`GAMES/includes/canvas/php/boot_lib.php`) puis vers `*_adapter_glue.php`.
- **Handlers glue (PHP)** : `GAMES/includes/canvas/php/*_adapter_glue.php` (logique métier + SQL).
...
- Contrat bridge : `docs/canon/interfaces/canvas-bridge.md`
- Registry actions + matrice write/read : `docs/canon/interfaces/actions.md`
- Writes Bingo (inventaire) : `docs/canon/data/bingo-write-map.md`
- Smoke tests : `docs/specs/smoke-canvas-api.md`
- WS (env/pm2) : `docs/pm2-ws.md`
